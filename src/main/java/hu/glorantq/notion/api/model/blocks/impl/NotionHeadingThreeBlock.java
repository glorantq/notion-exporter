...
@Getter
public class NotionHeadingThreeBlock extends NotionBlock {
    @Expose
    private List<NotionRichText> text;

    public NotionHeadingThreeBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
