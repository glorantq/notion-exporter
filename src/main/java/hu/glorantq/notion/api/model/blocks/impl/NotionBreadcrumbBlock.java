...
@Getter
public class NotionBreadcrumbBlock extends NotionBlock {
    public NotionBreadcrumbBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
