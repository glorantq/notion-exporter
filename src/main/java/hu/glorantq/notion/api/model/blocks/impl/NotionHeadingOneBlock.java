...
@Getter
public class NotionHeadingOneBlock extends NotionBlock {
    @Expose
    private List<NotionRichText> text;

    public NotionHeadingOneBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
