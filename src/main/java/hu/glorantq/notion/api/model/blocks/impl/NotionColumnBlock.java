...
@Getter
public class NotionColumnBlock extends NotionBlock {
    public NotionColumnBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
