...
@Getter
public class NotionToDoBlock extends NotionBlock {
    @Expose
    ...
    public NotionToDoBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
    ...
    public NotionBlock deserialize(JsonObject jsonObject, JsonDeserializationContext context) throws JsonParseException {
        ...
        checked = context.deserialize(jsonObject.get("checked"), boolean.class);
