...
@Getter
public class NotionHeadingTwoBlock extends NotionBlock {
    @Expose
    private List<NotionRichText> text;

    public NotionHeadingTwoBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
