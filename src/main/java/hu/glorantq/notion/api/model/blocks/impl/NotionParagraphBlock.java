...
@Getter
public class NotionParagraphBlock extends NotionBlock {
    @Expose
    ...
    public NotionParagraphBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
