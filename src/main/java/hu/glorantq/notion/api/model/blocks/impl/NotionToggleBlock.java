...
@Getter
public class NotionToggleBlock extends NotionBlock {
    @Expose
    ...
    public NotionToggleBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
