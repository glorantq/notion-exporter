...
@Getter
public class NotionPDFBlock extends NotionBlock {
    @Expose
    private NotionFile fileObject;

    public NotionPDFBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
