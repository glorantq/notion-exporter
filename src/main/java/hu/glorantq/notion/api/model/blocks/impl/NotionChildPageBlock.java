...
@Getter
public class NotionChildPageBlock extends NotionBlock {
    @Expose
    private String title;

    public NotionChildPageBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
