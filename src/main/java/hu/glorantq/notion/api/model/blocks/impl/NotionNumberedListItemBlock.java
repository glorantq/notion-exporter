...
@Getter
public class NotionNumberedListItemBlock extends NotionBlock {
    @Expose
    ...
    public NotionNumberedListItemBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
