...
@Getter
public class NotionVideoBlock extends NotionBlock {
    @Expose
    private NotionFile fileObject;

    public NotionVideoBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
