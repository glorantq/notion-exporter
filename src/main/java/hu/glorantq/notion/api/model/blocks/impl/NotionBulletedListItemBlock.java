...
@Getter
public class NotionBulletedListItemBlock extends NotionBlock {
    @Expose
    ...
    public NotionBulletedListItemBlock(String object, UUID id, Type type, Date createdTime, Date lastEditedTime, boolean archived, boolean hasChildren) {
